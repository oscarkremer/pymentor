...
mentor.pluralize('word') # returns 'words'
mentor.pluralize('goose') # returns 'geese'
mentor.singularize('phenomena') # returns 'phenomenon'
```
...
## License
[GPL-v3](https://choosealicense.com/licenses/)
